...
# DATE CREATED: 15/7/2024 [15th of july 2024]                                 
# REVISED DATE: 
    ...
    for idx in range(0, len(in_files), 1):
       ...
       # isn't an pet image file
        if in_files[idx][0] != ".":
            ...
            #First extract the parts of the filename
            dog_breed_name=in_files[idx].lower().split('_')

            #Holding the names of dog breed without .jpg and number
            for text in dog_breed_name:
                if text.isalpha(): #built in function to check the only alphabetic letters
                    pet_label+=text
                    pet_label+=' '
