...
# DATE CREATED: 7/14/2024 [14th of july 2024]
# REVISED DATE: 
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    for key in results_stats_dic:
        ...
        #
        if(key[0]=='p'):
                print(str(key)+": "+str(results_stats_dic[key]))
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            """We could make XOR bitwise operation to check 
            if one of them is truely a dog or not"""
            if (results_dic[key][3] ^ results_dic[key][4])==1:
                print(f"Pet label: {results_dic[key][0]} and Classifier label: {results_dic[key][1]}")
